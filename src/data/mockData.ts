import type {
  ...
  MaintenanceRecord, WeldingHistoryPoint, AlarmRecord, TraceEvent, DisposalRecord,
} from '@/types';
...
export const mockRepairRecords: RepairRecord[] = [
  {
    id: 'rr-001',
    workpieceId: 'wp-001',
    weldPointId: 'pt-001-28',
    weldPointIndex: 28,
    operator: '刘补焊工',
    repairTime: new Date(now.getTime() - 1000 * 60 * 31),
    description: '第28号焊点存在虚焊，已采用手工补焊完成，补焊参数符合标准',
    spatterCleaned: true,
    repairMethod: 'manual_spot',
    repairReason: 'cold_weld',
    reinspectionResult: 'pass',
    reinspectionOperator: '王质检员',
    reinspectionTime: new Date(now.getTime() - 1000 * 60 * 30),
    reinspectionNote: '超声波复检通过，虚焊消除',
  },
  {
    id: 'rr-002',
    workpieceId: 'wp-001',
    weldPointId: 'pt-001-19',
    weldPointIndex: 19,
    operator: '刘补焊工',
    repairTime: new Date(now.getTime() - 1000 * 60 * 19),
    description: '第19号焊点电流异常导致虚焊，手工补焊后复核合格',
    spatterCleaned: true,
    repairMethod: 'manual_spot',
    repairReason: 'param_abnormal',
    reinspectionResult: 'pass',
    reinspectionOperator: '王质检员',
    reinspectionTime: new Date(now.getTime() - 1000 * 60 * 18),
    reinspectionNote: '复检合格，焊接强度达标',
  },
];
...
export const mockAlarmRecords: AlarmRecord[] = [
  {
    ...
    createdBy: '监测系统',
    disposalRecordIds: ['dr-001-1', 'dr-001-2', 'dr-001-3', 'dr-001-4', 'dr-001-5'],
  },
  {
    id: 'al-002',
    ...
    createdBy: '王质检员',
    assignedTo: '刘补焊工',
    assignedAt: new Date(now.getTime() - 1000 * 60 * 34),
    disposalRecordIds: ['dr-002-1', 'dr-002-2', 'dr-002-3', 'dr-002-r', 'dr-002-4'],
  },
  {
    id: 'al-003',
    ...
    createdBy: '监测系统',
    assignedTo: '张巡检员',
    assignedAt: new Date(now.getTime() - 1000 * 60 * 4),
    disposalRecordIds: ['dr-003-1', 'dr-003-2'],
  },
];
...
export const mockDisposalRecords: DisposalRecord[] = [
  {
    ...
    status: 'pending',
    note: '焊接电流异常触发告警，电流=9780A，低于下限10000A',
    repairReason: 'param_abnormal',
  },
  {
    id: 'dr-001-2',
    ...
    phase: 'assign',
    operator: '调度系统',
    timestamp: new Date(now.getTime() - 1000 * 60 * 19.5),
    status: 'processing',
    note: '分派给刘补焊工进行处置',
  },
  {
    ...
    repairReason: 'param_abnormal',
    repairMethod: 'manual_spot',
    note: '采用手工补焊，补焊参数：电流12200A/压力360N/时间0.38s',
  },
  {
    id: 'dr-001-4',
    alarmId: 'al-001',
  ...
  },
  {
    ...
    phase: 'close',
    operator: '王质检员',
    timestamp: new Date(now.getTime() - 1000 * 60 * 17.8),
    status: 'closed',
    reinspectionResult: 'pass',
    note: '处置闭环，补焊+复检均合格，焊点质量符合要求',
  },
  {
    id: 'dr-002-1',
    alarmId: 'al-002',
    ...
    status: 'pending',
    repairReason: 'cold_weld',
    note: '超声检测发现第28号焊点虚焊，波形幅值偏低，底部回波明显',
  },
  {
    id: 'dr-002-2',
    alarmId: 'al-002',
  ...
  },
  {
    ...
    phase: 'reinspect',
    operator: '王质检员',
    timestamp: new Date(now.getTime() - 1000 * 60 * 30.5),
    status: 'closed',
    reinspectionResult: 'pass',
    note: '复检合格，虚焊消除，底部回波正常',
  },
  {
    id: 'dr-002-4',
    alarmId: 'al-002',
  ...
  },
  {
    ...
    status: 'pending',
    repairReason: 'param_abnormal',
    note: '电压瞬时波动至5.45V，高于上限5.2V，持续时间约80ms',
  },
  {
    id: 'dr-003-2',
    alarmId: 'al-003',
...
export const mockTraceEvents: TraceEvent[] = [
  ...
  },
  {
    ...
    abnormal: true,
    status: '异常',
    relatedAlarmId: 'al-001',
    relatedDisposalIds: ['dr-001-1', 'dr-001-2', 'dr-001-3', 'dr-001-4', 'dr-001-5'],
  },
  {
    id: 'te-005',
    phase: 'welding',
  ...
  },
  {
    ...
    status: '完成',
    duration: 245,
    relatedAlarmId: 'al-002',
    relatedDisposalIds: ['dr-002-1', 'dr-002-2', 'dr-002-3', 'dr-002-r', 'dr-002-4'],
  },
  {
    id: 'te-007',
    phase: 'repair',
  ...
  },
  {
    ...
    status: '合格',
    relatedAlarmId: 'al-002',
    relatedDisposalIds: ['dr-002-r', 'dr-002-4', 'dr-001-4', 'dr-001-5'],
  },
  {
    id: 'te-010',
    phase: 'maintenance',
